...
call mamba env create -p .conda/pythonqt -f conda/conda-env.yaml
...
call mamba run --live-stream -n pythonqt mamba-devenv --no-prune -f conda/environment.devenv.yml
